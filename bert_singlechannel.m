...
if strcmp(baseline, 'relchange') ==1 
   Outgram = Baseline2D(Outgram, base_start,base_end, 0);
   if NEpochs > 1
      evagram = Baseline2D(evagram, base_start,base_end, 0);
   end
elseif strcmp(baseline, 'subtract') ==1 
   Outgram = Baseline2D(Outgram, base_start,base_end);
   if NEpochs > 1
      evagram = Baseline2D(evagram, base_start,base_end);
   end
end
